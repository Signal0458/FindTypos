...
driver = webdriver.Chrome('/Users/GoodFe/driver/chromedriver')
driver.get("https://front.wemakeprice.com/main")


# search_box = driver.find_element_by_xpath('//*[@class="lay_ico ui_input_search"]/input')
# search_box.send_keys('라면')

#element 찾을때까지 5초간 0.5초마다 트라이
search_box = WebDriverWait(driver, 5).until(
    EC.presence_of_element_located((By.XPATH,'//*[@class="lay_ico ui_input_search"]/input'))
    )
search_box.send_keys('라면')
...
for i, element in enumerate(search_box_list):
    ...
    price = element.find_element_by_xpath('//*[@class="price_info"]//*[@class="num"]').text
    ...
    # 사전 형식으로 저장
    info = {'index':i,'name' : name, 'price' : price, 'shipFee' : ship_fee, 'shipDate' : ship_date}
